...
{
    constexpr int kelevatorCanId = 6;
    constexpr int kupperSafetyDioPort = 4;
    constexpr int klowerSafetyDioPort = 5;

    constexpr units::inch_t kDiameter = 1.359375_in;
    constexpr double kmotorReduction = 45.0; // 45:1
}

namespace PivotConstants
{
    constexpr int kPivotCanId = 11;
    constexpr int kleftSafetyDioPort = 1;
    constexpr int krightSafetyDioPort = 3;
    constexpr int kpot = 0;
}

namespace AlgaeConstants
{
    constexpr int kAlgaeCanId = 12;
    constexpr int kAlgaeDioPort = 0;
}

namespace CoralConstants
{
    constexpr int kCoralCanId = 13;
    constexpr int kCoralDioPort = 2;
}
...
constexpr units::meters_per_second_t kMaxSpeed = 2.0_mps;
